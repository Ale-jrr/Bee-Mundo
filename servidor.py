"""Servidor de desenvolvimento do Colmeia.

O `http.server` padrão manda Last-Modified e o navegador passa a reusar módulos
ES do cache mesmo depois de recarregar a página — o que já fez uma medição de
balanceamento rodar contra código velho sem avisar. Aqui todo arquivo sai com
...
if __name__ == '__main__':
    ...
    print(f'Colmeia servindo {raiz} (sem cache)')

...
let s=novoJogo(42);s.decorrido=EST*3;s.pote.silvestre=10;
...
s.decorrido=EST*4;s.ano=2;s.campos[0].alocadas=1;passo(s,1/30);ok('primavera retoma reservas',s.abelhas.some(a=>a.estado==='indo'));
